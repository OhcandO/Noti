...
public class likeInfoVO {
	...
	public int getLike_info_list_no() {
		return like_info_list_no;
	}
	public void setLike_info_list_no(int like_info_list_no) {
		this.like_info_list_no = like_info_list_no;
	}
	...
	public String getInfo_board_start() {
		return info_board_start;
	}
	public void setInfo_board_start(String info_board_start) {
