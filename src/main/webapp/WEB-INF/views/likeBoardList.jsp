      ...
      <div class="row">
		...
		<div class="container mt-3">
			<table id="likeUserList" class="table">
				...
				<c:forEach items="${likeUserList }" var="likeBoard">
					<!-- 프라퍼티이름 변경 -->
					<%
						
					%>
					<tr>
						<td align="center">${likeBoard.like_user_list_no}</td>
						<td align="center">${likeBoard.user_board_title}</td>
						<td align="center">${likeBoard.user_id}</td>
						<td align="center">${likeBoard.user_board_start}</td>
						<td align="center">${likeBoard.user_board_count}</td>
						<td align="center">${likeBoard.user_board_like}</td>
					</tr>
				</c:forEach>
